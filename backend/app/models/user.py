...
class User(Base):
    ...
    created_api_keys = relationship("APIKey", foreign_keys="[APIKey.created_by_id]", back_populates="creator")
    owned_api_keys = relationship("APIKey", foreign_keys="[APIKey.user_id]", back_populates="owner")
